...
ConfigSystem::ConfigSystem() {
    ...
    if (appdata_path) {
        config_directory = std::string(appdata_path) + "\\tg\\config";
        free(appdata_path);
    }
...
bool ConfigSystem::save_config(const std::string& name) {
    ...
    config_json["combat"]["autoswitch"] = globals::combat::autoswitch;
    ...
    config_json["combat"]["wallcheck"] = globals::combat::wallcheck;
    ...
    config_json["combat"]["camlockpart"] = globals::combat::camlockpart;
    config_json["combat"]["mouselockpart"] = globals::combat::mouselockpart;
    ...
    config_json["combat"]["connect_to_aimbot"] = globals::combat::connect_to_aimbot;
    ...
    if (file.is_open()) {
        try {
            ...
            if (config_json.is_discarded()) {
                ...
                if (combat.contains("autoswitch")) globals::combat::autoswitch = combat["autoswitch"];
                ...
                if (combat.contains("camlockpart")) globals::combat::camlockpart = combat["camlockpart"];
                if (combat.contains("mouselockpart")) globals::combat::mouselockpart = combat["mouselockpart"];
                ...
                if (combat.contains("connect_to_aimbot")) globals::combat::connect_to_aimbot = combat["connect_to_aimbot"];
