...
namespace math { 
    ...
    // Alias for compatibility with Givenchy's silent aim code
    using Matrix4x4 = Matrix4;
    
    // WorldToScreen function from Givenchy for silent aim compatibility
    inline Vector2 WorldToScreen(Vector3 world, Vector2 dimensions, Matrix4x4 viewmatrix) {
        Vector4 clipCoords = {
        ...
        Vector3 ndc = { clipCoords.x * inv_w, clipCoords.y * inv_w, clipCoords.z * inv_w };
